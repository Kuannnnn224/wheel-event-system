...
const config = {
  ...
  probabilityConfigPath: resolvePath(readString('PROBABILITY_CONFIG_PATH', '../backend/config/probability.json')),
  probabilityImportStoragePath: resolvePath(readString('PROBABILITY_IMPORT_STORAGE_PATH', '../storage/probability-imports')),
  frontendDistPath: resolvePath(readString('FRONTEND_DIST_PATH', '../frontend/dist')),
  webviewPublicPath: resolvePath(readString('WEBVIEW_PUBLIC_PATH', '../frontend/public'))
};
