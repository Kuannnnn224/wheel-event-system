...
This branch is arranged like a Node 8 runtime package: the admin frontend has already been built into `backend-node8/public`, and the backend serves those static files directly.
